...
enum class ButtonComponent(
    ...
    DPAD_UP(R.string.component_dpad_up, "D-Pad Up", ButtonAnchor.BOTTOM_LEFT),
    DPAD_DOWN(R.string.component_dpad_down, "D-Pad Down", ButtonAnchor.BOTTOM_LEFT),
    DPAD_LEFT(R.string.component_dpad_left, "D-Pad Left", ButtonAnchor.BOTTOM_LEFT),
    DPAD_RIGHT(R.string.component_dpad_right, "D-Pad Right", ButtonAnchor.BOTTOM_LEFT),
    FACE_BUTTONS(R.string.component_face_buttons, "Face Buttons (A/B/X/Y)", ButtonAnchor.TOP_RIGHT),
    FACE_BUTTON_A(R.string.component_face_button_a, "Face Button A", ButtonAnchor.TOP_RIGHT),
    FACE_BUTTON_B(R.string.component_face_button_b, "Face Button B", ButtonAnchor.TOP_RIGHT),
    FACE_BUTTON_X(R.string.component_face_button_x, "Face Button X", ButtonAnchor.TOP_RIGHT),
    FACE_BUTTON_Y(R.string.component_face_button_y, "Face Button Y", ButtonAnchor.TOP_RIGHT),
    ...
    SETTINGS_BUTTON(R.string.component_settings, "Settings", ButtonAnchor.TOP_CENTER),
    HOME_BUTTON(R.string.component_home, "Home (Guide)", ButtonAnchor.TOP_CENTER),
    CAPTURE_BUTTON(R.string.component_capture, "Capture (Share)", ButtonAnchor.TOP_CENTER);
