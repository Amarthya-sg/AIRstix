...
val GlossyYellow = Color(0xFFCCAA00)
val NeonPurple = Color(0xFFBD03FF)
val GlossyPurple = Color(0xFF7A1FA2)
val NeonOrange = Color(0xFFFF5E00)
val GlossyOrange = Color(0xFFE65100)
val NeonPink = Color(0xFFFF007F)
val GlossyPink = Color(0xFFC2185B)
